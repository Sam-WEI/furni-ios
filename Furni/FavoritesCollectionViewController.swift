...
class FavoritesCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout, MFMessageComposeViewControllerDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        let product = friends[(indexPath as NSIndexPath).section].favorites[(indexPath as NSIndexPath).row]
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        switch kind {
            case UICollectionElementKindSectionHeader:
                ...
                let user = friends[(indexPath as NSIndexPath).section]
            ...
            case UICollectionElementKindSectionFooter:
                let isLastSection = (indexPath as NSIndexPath).section == numberOfSections(in: collectionView) - 1
