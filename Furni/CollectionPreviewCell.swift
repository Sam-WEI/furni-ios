...
final class CollectionPreviewCell: UITableViewCell, CollectionTableViewCellType {

    static let reuseId = "CollectionPreviewCell"
    ...
    func configureWithCollection(_ collection: Collection) {
        ...
        artworkImageView.af_setImage(withURL:
            collection.imageURL,
